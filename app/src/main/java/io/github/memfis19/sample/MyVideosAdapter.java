...
public class MyVideosAdapter extends AAH_VideosAdapter {
    ...
    public void onBindViewHolder(final AAH_CustomViewHolder holder, int position) {
        if (list.get(position).getName().contains("video")) {
            ...
            if (list.get(position).getImage_url() != null && !list.get(position).getImage_url().isEmpty()) {
                decodeimage(holder.getAAH_ImageView(),list.get(position).getImage_url());
    ...
    public void decodeimage(ImageView image,String strBase64){
